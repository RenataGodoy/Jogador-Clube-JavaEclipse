...
public class JanelaConsultarClube extends JFrame {
	 ...
	 * Create the frame.
	 */
	public JanelaConsultarClube(CtrlConsultarClube c, Clube[] listaClube) {
		this.ctrl = c;
		setTitle("Clube");
		...
		this.atualizarDados(listaClube);
	...
	public void atualizarDados(Clube[] listaClube) {
		HelperTableModel h = new HelperTableModel(listaClube);
		if (tabela == null)
